...
Page({
  ...
  getAllTotal: function (taskID, startDay, endDay) {
    ...
    wx.request({
      url: 'https://31877669.qcloud.la' + taskID + '&startDate=' + startDay + '&endDate='+ endDay,
      method: 'GET',
  ...
  getSingleTotal: function (openId, taskID, startDay, endDay) {
    ...
    wx.request({
      url: 'https://31877669.qcloud.la' + openId + '&taskID=' + taskID + '&startDate=' + startDay + '&endDate='+ endDay,
      method: 'GET',
      success: function(res){
        // success
        var d = res.data.data;
  ...
  getSingleRecord: function (openId, taskID, startDay, endDay, detail) {
    ...
    wx.request({
      url: 'https://31877669.qcloud.la' + openId + '&taskID=' + taskID + '&startDate=' + startDay + '&endDate='+ endDay + '&detail=' + detail,
      method: 'GET',
      success: function(res){
        // success
        var d = res.data.data;
